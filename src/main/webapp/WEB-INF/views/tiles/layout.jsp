	        ...
	        <ul class="navbar-nav ml-auto">
	            ...
	            <c:choose>
		            <c:when test="${sessionScope.memberLogin eq null }">
		            	<li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/loginForm.do">로그인</a></li>
		        	</c:when>
		        	<c:otherwise>
		        		<li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/memberLogout.do">로그아웃</a></li>	        	
		        	</c:otherwise>
	        	</c:choose>
	        </ul>
	    </div>
