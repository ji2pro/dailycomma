            ...
            <div class="col-md-12">
                <div class="carousel slide" data-ride="carousel" id="carousel">
                    <div class="carousel-inner">
                        ${getDetailRoom.roomImg}
                        ${getDetailRoom.roomInfo}
                        <c:forTokens items="${getDetailRoom.roomImg}" delims="||" var="img" varStatus="status">
                ...
                <div class="tab-content mt-2">
                    <div class="tab-pane fade active show" id="tabone" role="tabpanel">
                        <div class="row py-4 border-bottom border-secondary">
                            <div class="col">
                                <div class="roomtitle">${getDetailRoom.roomName}</div>
                                <div class="roomtip">객실 정보 : ${getDetailRoom.roomInfo}</div>
                                <div class="roomtip">기준2명 (최대인원${getDetailRoom.roomQuantity}명)</div>
                                <div class="py-3"><span class="room-label f-right" >숙박${getDetailRoom.roomPrice}원</span></div>
                        ...
                        <div class="row py-4 border-bottom border-secondary">
                            <div class="col">
                                ...
                                <div class="py-3">
                                    <span class="room-label">숙박</span>
                                    <span><input class="f-right">원</span></div>
                                <button class="btn btn-info btn-block color-gradation"> 예약하기</button>
                            </div>
                            <div class="col">
                                <img class="d-block img-fluid w-100 rounded" src="../../객실이미지1.png">
