		...
		<div class="container">
			<div class="row">
				<ul class="nav nav-tabs mb-3" id="myPageTabs" role="tablist">
					<li class="nav-item"><a class="nav-link" id="pointTab"
						href="point.do" aria-controls="point" aria-selected="true"
						data-target="#point" data-toggle="tab" role="tab">포인트</a></li>
					<li class="nav-item"><a class="nav-link" id="reserveTab"
						href="reserve.do" aria-controls="reserve" aria-selected="true"
						data-target="#reserve" data-toggle="tab" role="tab">예약 내역</a></li>
					<li class="nav-item"><a class="nav-link" id="countryTab"
						href="country.do" aria-controls="country" aria-selected="true"
						data-target="#country" data-toggle="tab" role="tab">최근 본 숙소</a></li>
				</ul>
			</div>
		...
		$(function() {
			...
			$('#myPageTabs li a').on(
					...
					function(e) {
						...
						var loadurl = $(this).attr('href'), target = $(this)
								.attr('data-target');
